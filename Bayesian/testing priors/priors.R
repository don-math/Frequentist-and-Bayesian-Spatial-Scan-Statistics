...
# save the results 
Bay_final_results002 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results002, file="Bay_final_results002.RData")
...
# save the results 
Bay_final_results003 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results003, file="Bay_final_results003.RData")
...
# save the results 
Bay_final_results004 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results004, file="Bay_final_results004.RData")
...
# save the results 
Bay_final_results005 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results005, file="Bay_final_results005.RData")
...
# save the results 
Bay_final_results006 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results006, file="Bay_final_results006.RData")
...
# save the results 
Bay_final_results007 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results007, file="Bay_final_results007.RData")
...
# save the results 
Bay_final_results = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results, file="Bay_final_results.RData")
...
# save the results 
Bay_final_results009 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results009, file="Bay_final_results009.RData")
...
# save the results 
Bay_final_results010 = foreach(t = mis_locations, .packages = c("foreach","neastbenchmark","parallel","doParallel","Brobdingnag")) %do% {
...
save(Bay_final_results010, file="Bay_final_results010.RData")
